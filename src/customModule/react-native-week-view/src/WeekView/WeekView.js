...
export default class WeekView extends Component {
  ...
  componentDidMount() {
    requestAnimationFrame(() => {
      if(this.calendar !== null) this.calendar.scrollTo({ y: 0, x: 2 * (SCREEN_WIDTH - 60), animated: false });
      if(this.scroller !== null) this.scroller.scrollTo({ y: 650, x: 0, animated: true });
    });
  }
